  ...
  def trade_basket (self, state: TradingState) -> list[Order]: 
    ...
    if res_sell > trade_at: #selling the gift baskets
      ...
      if vol > 0:
        ...
        # orders['STRAWBERRIES'].append(Order('STRAWBERRIES', worst_sell['STRAWBERRIES'], int(5.8*vol)))
    ...
    elif res_buy < 0 and res_buy > -trade_at:
      position = state.position.get('GIFT_BASKET', 0)
      if position < 0:
        ...
        # orders['STRAWBERRIES'].append(Order('STRAWBERRIES', worst_buy['STRAWBERRIES'], int(5.8*vol)))
